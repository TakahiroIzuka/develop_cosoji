...
<title>こそーじ | 地域の方に安価で手軽にお掃除依頼1,500円〜</title>
...
<body>
    ...
    //テーブルロック開始
    $sql='LOCK TABLES owner_info_table WRITE, owner_content_table WRITE';
    $stmt=$dbh->prepare($sql);
    $stmt->execute();
        
    //SQL文にてお客様情報を入力
    $sql='INSERT INTO owner_info_table(family_name, first_name, family_name_kana, first_name_kana, email, age, sex, zip1, zip2, prefecture, address, tel) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)';
    $stmt=$dbh->prepare($sql);
    $data[]=$family_name;
    $data[]=$first_name;
    ...
    //SQL文にて質問内容を入力
    $sql='INSERT INTO owner_content_table(code, subject, content) VALUES (?,?,?)';
    $stmt=$dbh->prepare($sql);
    $data=array();
    $data[]=$lastcode;
    $data[]=$subject;
    ...
    <header class="header">
        ...
        <section>
            ...
            <dl>
                ...
                <div class="wrapper-button">
                    <a href="../index.html" class="return-top">
        ...
        <div class="footer-container">
                ...
                <ul>
                    <li id="rule"><div class="icon"></div><a href="../terms/">利用規約</a></li>
                    <li id="policy"><div class="icon"></div><a href="../privacy/">プライバシーポリシー</a></li>
                </ul>
                <ul>
                    <li id="request"><div class="icon"></div><a href="../../worker/">お仕事をしたい方は<span>こちら</span></a></li>
                </ul>
         </div>
